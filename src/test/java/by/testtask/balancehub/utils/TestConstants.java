...
public interface TestConstants {
    ...
    Long USERNAME_3_ID = 2L;
    Long USERNAME_4_ID = 4L;

    List<String> USERNAME_1_EMAIL = List.of("alice1@test.com", "alice2@test.com");
    List<String> USERNAME_2_EMAIL = List.of("bob1@test.com", "bob2@test.com");
    List<String> USERNAME_3_EMAIL = List.of("charlie1@test.com", "charlie2@test.com");
    List<String> USERNAME_4_EMAIL = List.of("diana1@test.com", "diana2@test.com");

    List<String> USERNAME_1_PHONE = List.of("79201111101", "79201111102");
    List<String> USERNAME_2_PHONE = List.of("79202222201", "792022222202");
    List<String> USERNAME_3_PHONE = List.of("79203333301", "792033333302");
    List<String> USERNAME_4_PHONE = List.of("79204444401", "79204444402");
