...
public interface TestConstants {
    ...
    String USERNAME_FOR_NEW_1 = "John Doe";
    ...
    List<String> USERNAME_FOR_NEW_1_EMAIL_LIST = List.of("jondoe1@test.com", "jondoe2@test.com");
    ...
    List<String> USERNAME_FOR_NEW_1_PHONE_LIST = List.of("79205555501", "79205555502");
    ...
    LocalDate USERNAME_FOR_NEW_1_DATE_OF_BIRTH = LocalDate.of(1953, 2,25);
    ...
    String USERNAME_FOR_NEW_1_PASSWORD = "jonDoePa55";
