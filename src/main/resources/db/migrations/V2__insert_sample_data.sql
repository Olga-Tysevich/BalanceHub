...
VALUES (1, 1, 'alice1@test.com'),
       ...
       (8, 4, 'diana2@test.com'),
       (9, 5, 'ethan1@test.com'),
       (10, 5, 'ethan2@test.com'),
       (11, 6, 'fiona1@test.com'),
       (12, 6, 'fiona2@test.com'),
       (13, 7, 'george1@test.com'),
       (14, 7, 'george2@test.com'),
       (15, 8, 'hannah1@test.com'),
       (16, 8, 'hannah2@test.com'),
       (17, 9, 'ian1@test.com'),
       (18, 9, 'ian2@test.com'),
       (19, 10, 'julia1@test.com'),
       (20, 10, 'julia2@test.com');

INSERT INTO accounts (id, user_id, balance, hold)
VALUES (1, 1, 1000.00, 0.00),
       (2, 2, 1500.50, 0.00),
       (3, 3, 900.00, 0.00),
       (4, 4, 1100.25, 0.00),
       (5, 5, 2000.00, 0.00),
...
INSERT INTO transfers (id, from_account_id, to_account_id, amount, status, created_at, confirmed_at, version)
VALUES (1, 1, 2, 100.00, 'COMPLETED', '2025-05-10 10:00:00', '2025-05-10 10:05:00', 0),
       (2, 2, 3, 150.75, 'COMPLETED', '2025-05-10 11:00:00', '2025-05-10 11:03:00', 0),
       (3, 3, 4, 50.00, 'PENDING', '2025-05-10 12:00:00', '2025-05-10 12:00:00', 0),
       (4, 4, 5, 200.00, 'FAILED', '2025-05-10 13:00:00', '2025-05-10 13:05:00', 0),
       (5, 5, 1, 75.25, 'COMPLETED', '2025-05-10 14:00:00', '2025-05-10 14:10:00', 0);
...
SELECT setval('transfer_id_seq', 5, true);
